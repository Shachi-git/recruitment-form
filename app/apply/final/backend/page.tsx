...
import GeneralSkills from '@/components/sections/final/backend/general-skills'
import SpecificSkills from '@/components/sections/final/backend/specific-skills'
...
const Page = () => {
  ...
  const LOCAL_STORAGE_KEY = 'backendFormData'
  ...
  const handleSubmit = async () => {
    const result = backendFormSchema.safeParse(formData)
    ...
    try {
      const res = await fetch('/api/final/backend', {
        method: 'POST',
    ...
    <div className="w-full min-h-full flex flex-col items-center justify-center">
      {step === 1 && (
        <div className="w-full flex flex-col gap-5">
          ...
          <InfoContainer
            id="whatsapp"
            question="WhatsApp Contact Number:"
            required
            type="text"
            placeholder="Your answer"
